...
function AboutPage() {
  return (
    <section className="my-10 p-4">
      ...
      <h2 className="w-3/4 md:text-5xl xl:text:6xl  font-semibold mb-4 text-4xl">
      ...
      <div className="xl:hidden mt-10 flex justify-around  max-sm:flex-col max-sm:items-start">
        <h3 className="w-2/6 text-4xl font-semibold max-sm:w-full max-sm:my-4 max-xl:w-full">
          Our <span className="text-gray-500">Misson</span>
        </h3>

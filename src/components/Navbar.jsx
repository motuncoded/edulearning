...
<h1 className='fs-500'>Edulearning</h1>  
</div> 
  <nav  className='primary-navigation '>
    <ul className={isOpen ? 'nav-wrapper active' : 'nav-wrapper'} >
       <li className='fs-500 fw-500'> <Link className={location.pathname === "/" ? "activeClass" : "inactiveClass" } to="/">Home</Link></li>
       <li> <Link className={location.pathname === "/courses" ? "activeClass" : "inactiveClass" } to="courses">Courses</Link></li>
        <li><Link className={location.pathname === "/resources" ? "activeClass" : "inactiveClass" } to="resources">Resources</Link></li>
